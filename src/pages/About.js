  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium ml-4">
        ...
        <div className="space-y-8 ml-4">
          ...
          <p>
            Our 4 luxury cabins provide a cozy base, but the real freedom and
      ...
      <div className="col-span-2 mr-4 mt-6">
        <img
          src='/about-1.jpg'
      ...
      <div className="col-span-2 relative aspect-square mb-4 ml-4">
        <img src="/about-2.jpg" className="object-cover" fill alt="Family that manages The Wild Oasis" />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <div>
            <Link
              to="/cabins"
              className="inline-block mb-4 mt-4 bg-accent-500 px-8 py-5 text-primary-800 text-lg font-semibold hover:bg-accent-600 transition-all"
            >
